<template>
  <div>
    ...
    <Head title="Polls" />
    <h1 class="mb-8 text-3xl font-bold">Polls</h1>
    <div class="flex items-center justify-between mb-6">
      ...
      <Link class="btn-indigo" href="/polls/create">
      <span>Create</span>
        ...
        <tbody>
          <tr v-for="poll in polls.data" :key="poll.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
            ...
            <td class="w-px border-t">
              <Link class="flex items-center px-4" :href="`/polls/${poll.id}/edit`" tabindex="-1">
    ...
    <pagination class="mt-6" :links="polls.links" />
  </div>
</template>
  ...
  watch: {
    form: {
      ...
      handler: throttle(function () {
        this.$inertia.get('/polls', pickBy(this.form), { preserveState: true })
      }, 150),
    },
  },
  methods: {
